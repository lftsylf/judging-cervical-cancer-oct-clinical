#!/usr/bin/env bash
# ViT-Small T0 对比：标准多模态（Focal+EDL），关闭 WMA / EMA / AUX / CORAL。
# 3 折 × 5 seeds，30 epoch，batch=2。输出根目录：outputs_comparison_vit_small/
set -euo pipefail
...
echo "======================================"
echo "ViT-Small 对比全部完成: ${PROJECT_ROOT}/outputs_comparison_vit_small"
echo "======================================"
