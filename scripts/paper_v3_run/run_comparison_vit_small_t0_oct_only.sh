#!/usr/bin/env bash
# T0 ViT-Small 对比（v2 单模态 · OCT-only）：plain Focal+EDL，无 WMA/EMA/Aux
#
# 前台：
...
# 输出：outputs/第三版/对比试验v2单模态/outputs_comparison_v2_oct_vit_small/
set -euo pipefail

COMPARISON_TAG=vit_small
COMPARISON_BACKBONE=vit_small_patch16_224
