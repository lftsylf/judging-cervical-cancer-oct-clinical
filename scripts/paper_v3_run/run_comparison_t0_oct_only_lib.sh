...
#
# 调用方必须设置：
#   COMPARISON_TAG      — swin_tiny | swin_small | convnext_small | vit_small | resnet18 | densenet121 | dinov3_small
...
COMPARISON_PARENT="${COMPARISON_PARENT:-$PROJECT_ROOT/outputs/第三版/对比试验v2单模态}"
