...
| `feature/v2-resnet-baseline` | 分支 | `c9d30fe`（当前定稿） | v2 开发线：ResNet50 + 临床消融 + OCT-only 定稿 |
| `paper-v2-resnet50-oct-baseline` | annotated tag | `c9d30fe` | v2 定稿 baseline：ResNet50、OCT-only、LR=5e-5、POS_WEIGHT=1.25 |
