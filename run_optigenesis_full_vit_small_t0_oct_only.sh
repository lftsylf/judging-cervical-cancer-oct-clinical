...
#
# 输出：outputs/对比试验v2单模态/outputs_full_v2_oct_vit_small/
set -euo pipefail
...
ABLATION_OUT_ROOT="${ABLATION_OUT_ROOT:-$(cd "$(dirname "$0")" && pwd)/outputs/对比试验v2单模态/outputs_full_v2_oct_vit_small}"
